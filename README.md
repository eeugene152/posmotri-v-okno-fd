...
![Превью проекта](./images/preview.gif)
...
- Исправлены ошибки с принудительным скрытием контента (`overflow-x: hidden`), что вскрыло дополнительные проблемы с паразитным скроллбаром. Проблему решешил через проверку и перерасчет отступов блоков.
